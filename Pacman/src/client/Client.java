...
/**
 * The client class manages the relationship between the server (game logic), the communication interface and the GUI.
 * @author Stefan
 *
 */
public class Client implements GUIListener, CommEventListener{
	...
	/**
	 * Sends the change in direction from the GUI server.
	 */
	@Override
	...
	/**
	 * Sends a connect request from the GUI to the server.
	 */
	@Override
	...
	/**
	 * Sends a disconnect request from the GUI to the server.
	 */
	@Override
	...
	/**
	 * Opens a new server with the game logic.
	 */
	@Override
	...
	/**
	 * Sends a ready command from the game host (the player who opened the game) to the server.
	 */
	public void ready(){
	...
	/**
	 * Passes communication events (generated by the server) from the communication interface to the GUI. 
	 */
	@Override
