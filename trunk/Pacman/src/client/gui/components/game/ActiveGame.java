...
/**
 * This is the game area which consists of the game field and a status/control panel. This is displayed when the actual active gaming starts.
 * @author Stefan
 *
 */
public class ActiveGame extends View implements KeyEventDispatcher, ExtendedCommEventListener, Runnable, ActionListener{
	...
	/**
	 * Handles communication events generated by the server via the communication interface.
	 */
	@Override
	...
	/**
	 * Handles the events from the buttons at the left side of the game area.
	 */
	@Override
	...
	/**
	 * Handles the direction changes for the different pacmans.
	 */
	@Override
